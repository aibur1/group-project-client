...
const BlogDetails = () => {
  ...
  const onSubmit = (submitData) => {
    ...
    submitData.posterPhoto = user?.photoURL
      ? user.photoURL
      : "https://i.ibb.co/jwLpZMr/user-profile.png";
  ...
  return (
    <div className="">
      ...
      <div className="container py-4">
        <h1 className="fw-bolder text-start">{post?.title}</h1>
        <div className="d-flex justify-content-between align-items-center p-3 bg-light border-bottom border-2">
          <div className="text-start d-flex align-items-center">
            ...
            <div className="ms-2">
              <p className="mb-0">
                By <span className="fw-bold">{post?.name}</span>
              </p>
        ...
        <div className="bg-light p-3">
          <img src={`data:image/png;base64,${post.image}`} className="img-fluid" alt="" />
            
        <div className="text-start py-2 px-3">
          <h5 className="border-bottom border-3 fw-bold">
            Describe....
          </h5>
          ...
          <div className="p-3">
            <div className="w-100">
              <h5 className="text-start border-bottom border-3 mb-4">
                Comments....
              </h5>
              <form
              ...
              >
                ...
                <textarea
                  ...
                  className="w-100 p-1 mb-0 me-1"
                  {...register("comment", {})}
                />
                <button className="border-0 p-2 comment-btn" type="submit">
                  <span>
              ...
              {findComments?.map((comment) => (
                ...
                >
                  ...
                  <div className="text-start w-100 px-3 border-start border-end border-2 me-2">
                    ...
                    <span className="fw-bold me-3 text-uppercase fs-6">
                      {comment?.posterName}
                    </span>
                    <span>{comment?.commData}</span>
                  </div>
                  <div className="">
                    <p className="px-2 py-1 rounded-2 bg-light mb-0 fw-bold">
                      Replay
                    </p>
                  </div>
                </div>
